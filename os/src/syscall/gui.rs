...
use crate::{
    fs::ROOT_INODE,
    gui::{Button, Component, IconController, ImageComp, Panel, Terminal, Window, DESKTOP},
    sync::UPIntrFreeCell,
};
...
pub fn create_app() -> isize {
    ...
    //     "".to_string(),
    // ));
    // let text = Panel::new(Size::new(400, 400), Point::new(600, 100));
    // let button = Button::new(
    //     Size::new(20, 20),
    //     Point::new(370, 10),
    //     Some(arc_t.clone()),
